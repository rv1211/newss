...
$(function(){
  var hiddenurl = $('#hiddenUrl').val();
    ...
    $(document).ready(function() {
        $.ajax({
            url: hiddenurl+'reverseorderlist/count_data_records',
            dataType: "json",
...
$(document).ready(function () {
    ...
    var vieworder_tbl1 = $('#vieworder_tbl1').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getManifestedAjex',
        },
        "columnDefs": [
            {
                "targets": [ 9, 10 ,11],
    ...
    var vieworder_tbl2 = $('#vieworder_tbl2').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getIntransitAjex',
        },
        "columnDefs": [
            {
                "targets": [ 9, 8,10 ],
    ...
    var vieworder_tbl3 = $('#vieworder_tbl3').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getPendingAjex',
        },
        "columnDefs": [
            {
                "targets": [ 8,9],
    ...
    var vieworder_tbl4 = $('#vieworder_tbl4').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getDispatchedAjex',
        },
        "columnDefs": [
            {
                "targets": [ 8 ,9],
    ...
    var vieworder_tbl5 = $('#vieworder_tbl5').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getDeliveredAjex',
        },
        "columnDefs": [
            {
                "targets": [ 8,9 ],
    ...
    var vieworder_tbl6 = $('#vieworder_tbl6').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getCancelledAjex',
        },
        "columnDefs": [
            {
                "targets": [ 9 ],
    ...
    var vieworder_tbl7 = $('#vieworder_tbl7').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getNotPickedAjex',
        },
        "columnDefs": [
            {
                "targets": [ 8 ],
    ...
    var vieworder_tbl8 = $('#vieworder_tbl8').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getReturnedAjex',
        },
        "columnDefs": [
            {
                "targets": [ 8],
    ...
    var vieworder_tbl9 = $('#vieworder_tbl9').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getNotFoundAjex',
        },
        "columnDefs": [
            {
                "targets": [ 8],
   ...
   var vieworder_tbl10 = $('#vieworder_tbl10').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": hiddenurl+'reverseorderlist/getofpAjex',
        },
        "columnDefs": [
            {
                "targets": [ 8],
