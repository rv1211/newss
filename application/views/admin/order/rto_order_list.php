<style type="text/css">
	...
	/* .export_btn_order_rto_intransit {
    left: 380%;
    height: 40px;
    margin-top: -163px;
} */

	/* .rtointransit_orders_export{
					...
					<?php if ($this->session->userdata('userType') == '1') { ?>
						...
						<div class="dropdown-menu assign_label_choose_div" aria-labelledby="exampleSizingDropdown2" role="menu" x-placement="top-start" style="position: absolute; left: 0px; will-change: transform; transform: translate3d(0px, -5px, 0px);">
							<?php if ($assign_labels) {
									...
									<div class="scroller" style="display:flex">
										<div class="radio-btn">
											<input type="radio" name="radio_btn" <?php if ($key == '5' || 1) {
																						echo "checked";
						...
						<div class="example-wrap">
							<div class="nav-tabs-horizontal" data-plugin="tabs">
								...
								<div class="tab-content pt-20">
									...
									<div class="tab-pane active" id="rto_intransit_tab" role="tabpanel">
										<table class="table table-striped table-borderd" id="order_rto_intransit">
											<thead>
												<tr>
...
<!-- ndr comment Modal -->
<div class="modal fade modal-fade-in-scale-up ndr" id="ndr_order_comment" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-simple modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">NDR Comments</h4>
			</div>
			<div class="modal-body modal-body-ndr">
				<!-- <h4>NDR Comments</h4> -->
				<div class="ndr_comment"></div>
			</div>
