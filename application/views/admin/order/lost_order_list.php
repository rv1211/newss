							...
							<div class="nav-tabs-horizontal" data-plugin="tabs">
								...
								<div class="tab-content pt-20">
									...
									<div class="tab-pane active" id="created_tab" role="tabpanel">
										<table class="table table-striped table-borderd" id="lostorder_list">
											<thead>
												<tr>
													<th class="noExport"><input type="checkbox" class="lost_list_order" id="select_all" name="select_all" value="1"></th>
													<th>Order ID</th>
													<th>Order Number</th>
