                            ...
                            <div class="nav-tabs-horizontal" data-plugin="tabs">
                                ...
                                <div class="tab-content pt-20">
                                    ...
                                    <div class="tab-pane active" id="ndr_tab" role="tabpanel">
                                        <table class="table table-striped table-borderd" id="pre_awb_order_ndr">
                                            <thead>
                                                <tr>
...
<!-- End model -->
<!-- ndr comment Modal -->
<div class="modal fade modal-fade-in-scale-up" id="pre_ndr_order_comment" aria-hidden="true"
