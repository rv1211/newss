...
<body>
	<div class="page-container">
		<div class="border-div">
			<table class="wrapper-page1" width="100%" style="border: none;" cellspacing="0" cellpadding="10">
				...
				<tr style="padding:5px;">
					...
					<td style="text-align: center;"><?php if ($order_info['order_type'] == 0) {
				...
				<tr>
					<td style="text-align:left;">
						...
						<span>
							<?php echo wordwrap($order_info['deliver_address_1'] . "," . $order_info['deliver_address_2'], 25, "<br>\n", TRUE); ?>
							<br><?php echo $order_info['deliver_city'] . "," . $order_info['deliver_state'] . "," . $order_info['deliver_pincode'] ?><br>
						</span>
						Phone No: <?php echo $order_info['deliver_mobile_no']; ?><br><br>
				...
				<tr>
					...
					<td colspan="2">
						...
						<div style="margin-left: 200; padding-left:80;">
							...
							$base64_img = 'data:image/' . $type . ';base64,' . base64_encode($file_data);
							?>
							<img src="<?php echo $base64_img; ?>" width="250" height="50">
						</div>
					</td>
				</tr>
			</table>
			<div style="margin-bottom:10px;">
				<strong>Note :-No Open Delivery Allowed </strong><br>

			</div>
			<table style="border: 1px solid black;margin-top:12px;" width="100%">
				<tr>
					<td>
			...
			<table width="100%" style="border: none;" cellspacing="0" cellpadding="10">
