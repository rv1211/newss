	...
	<div class="page-container">
		<div class="border-div">
			<?php foreach ($order_info as $single_order) { ?>
					...
					<tr>
						...
						<td>
							...
							<div style="margin-left: 200; padding-left:80;">
								...
								$base64_img = 'data:image/' . $type . ';base64,' . base64_encode($file_data);
								?>
								<img src="<?php echo $base64_img; ?>" width="350" height="90">
							</div>
						</td>
					</tr>
				</table>
				...
				<table style="border: 1px solid black;margin-top:2px;" width="100%">
					<tr>
						<td>
							...
							Order Number: <b><?= $single_order['customer_order_no']; ?></b><br>
				...
				<table width="100%" style="border:1px solid;margin-top:1px;" cellspacing="0" cellpadding="10">
					<tr>
