						...
						<div class="example-wrap">
							<div class="nav-tabs-horizontal" data-plugin="tabs">
								...
								<div class="tab-content pt-20">
									...
									<div class="tab-pane active" id="ndr_tab" role="tabpanel">
										<table class="table table-striped table-borderd" id="order_ndr">
											<thead>
												<tr>
...
<!-- Modal -->
<div class="modal fade modal-fade-in-scale-up ndr-details" id="myModal" role="dialog">
