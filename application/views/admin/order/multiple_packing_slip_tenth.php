				...
				<?php foreach ($order_info as $single_order) { ?>
					<table class="table_order wrapper-page1" cellpadding="0" cellspacing="0">
						<tr>
							...
							$base64_img = 'data:image/' . $type . ';base64,' . base64_encode($file_data);
							?>
							<td colspan="1" class="border-bottom border-left border-right"><img src="<?php echo $base64_img; ?>" alt="Pack And Drop"></td>
                ...
                <td></td>
						...
						<tr>
							<td class="" colspan="3" style="text-align:center;">
								...
								<?php
								$path = $single_order['uddan_barcode_img'];
								$type = pathinfo($path, PATHINFO_EXTENSION);
								$file_data = file_get_contents($path);
								$base64_img = 'data:image/' . $type . ';base64,' . base64_encode($file_data);
								?>
						...
						?>
						<tr>
							<td class="" colspan="3" style="text-align:center; border:none;">
