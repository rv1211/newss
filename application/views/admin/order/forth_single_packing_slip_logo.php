	...
	<div class="row">
		<table class="table_order" cellpadding="0" class="wrapper-page1" cellspacing="0" style="margin-top: 25px;">
			<tr class="logo-main">
				...
				$base64_img = 'data:image/' . $type . ';base64,' . base64_encode($file_data);
				?>
				<td class="logo2" style="text-align:center;"><img src="<?php echo $base64_img; ?>" height="80" width="210" alt="ShipSecure"></td>

				<td class="" style="text-align:center;"><b><?php if ($order_info['order_type'] == 0 || $order_info['order_type'] == "0") {
			...
			<tr>
				<td class="padding" colspan="3" style="font-size: 19px;">
			...
			<tr>
				<td class="padding" colspan="3">Note-No Open Delivery Allowed <br> <br>
					<b>Order No.- <?php echo $order_info['customer_order_no']; ?> </b>
				</td>
			</tr>
			<!-- <tr>
                <td class="padding" class="td" colspan="2"></td>
                <td class="padding"></td>
            </tr> -->
			<tr>
				<td class="padding" colspan="3" style="font-size: 20px;"> Sender Info :<b> <br>
						<?php echo $order_info['sender_name'] ?><br></b>
					<b>Email : </b><?php echo $order_info['pickup_email'] ?><br>
					<?php //echo $order_info['pickup_address_1']; 
					?>
					<?php //echo $order_info['pickup_address_2']; 
					?>
					<?php // echo $order_info['pickup_city'] . ", " . $order_info['pickup_state'] . "-" . $order_info['pickup_pincode']; 
					?>
				...
				<!-- <td class="padding" style="text-align: center;">
                    <h3><?php echo $order_info['pickup_state'] ?></h3>
                    <h3><?php echo $order_info['pickup_pincode']; ?></h3>
                </td> -->

			</tr>
			<tr>
				<td class="padding" colspan="2" style="font-size: 20px;"> Buyer Details :<b> <br>
			...
			<tr>
				<td class="td padding" colspan="3" style="text-align:center;"><?php //echo $order_info['logistic_name']; 
																				?></td>
			</tr>
			<tr>
				<td class="td padding" colspan="3" style="text-align:center;">
					<?php
			...
			<tr>
				<br> <br> <br> <br>
				<td class="td padding" colspan="3" style="text-align:center;"><?php echo $order_info['awb_number']; ?></td>
			</tr>
		</table>
	</div>
</body>
