            ...
            <div class="example-wrap">
              <div class="nav-tabs-horizontal" data-plugin="tabs">
                <ul class="nav nav-tabs" role="tablist">
                  <!-- <li class="nav-item" role="presentation"><a class="nav-link orderList active" href="<?php echo base_url('Pre-awb-onprocess-order-list'); ?>" aria-controls="all_tab" role="tab">On Process {<span><?php echo $order_count['get_pre_awb_onprocess_order_list'] ?></span>}</a></li>
                  ...
                  <li class="nav-item" role="presentation"><a class="nav-link orderList" id="" href="<?php echo base_url('Pre-awb-createdOrderList'); ?>" aria-controls="created_tab" role="tab">Created {<span><?php echo $order_count['get_pre_awb_created_order_list'] ?></span>}</a></li>
                ...
                <div class="tab-content pt-20">
                  <div class="tab-pane active" id="all_tab" role="tabpanel">
                    <table class="table table-striped table-borderd" id="pre_awb_onprocess_order_table">
                      <thead>
                        <tr>
