		...
		<table class="table_order" cellpadding="0" class="wrapper-page1" cellspacing="0">
			<tr>
				...
				<td style="text-align:center;"><b><?php if ($order_info['order_type'] == 0) {
					...
					<h3>Rs. <?php echo $order_info['cod_amount']; ?></h3>
				</td>
				<td></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="td" colspan="3" style="text-align:center;"><img src="<?php echo $order_info['base64_barcode_img']; ?>" width="400" height="100">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3">
					<strong>Ship Date:</strong> <?= date('d-m-Y', strtotime($order_info['created_date'])); ?><br />
					<strong>Invoice Date:</strong>
					<?= date('d-m-Y', strtotime($order_info['created_date'])); ?><br />
					<strong>Invoice No:</strong> <?= $order_info['order_no']; ?><br />
				</td>
			</tr>
		</table>
	</div>
