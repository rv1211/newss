			...
			<?php foreach ($order_info as $single_order) { ?>
				<table class="table_order wrapper-page1" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td colspan="1" style="text-align:center;"><b><?php if ($single_order['order_type'] == 0) {
					...
					<tr>
						<td colspan="3" class="border-bottom" style="text-align: left;">
							<strong>Ship Date:</strong>
							<?= date('d-m-Y', strtotime($single_order['created_date'])); ?><br />
							<strong>Invoice Date:</strong>
							<?= date('d-m-Y', strtotime($single_order['created_date'])); ?><br />
							<strong>Invoice No:</strong> <?= $single_order['order_no']; ?>< </td>
					</tr>
				</table>
			<?php } ?>
		</div>
