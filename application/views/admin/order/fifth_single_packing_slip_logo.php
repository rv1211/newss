	...
	<div class="row">
		<table class="table_order" cellpadding="0" class="wrapper-page1" cellspacing="0">
			<tr>
				...
				$base64_img = 'data:image/' . $type . ';base64,' . base64_encode($file_data);
				?>
				<td colspan="1" class="border-bottom border-left border-right"><img src="<?php echo $base64_img; ?>" height="80" width="200" alt="ShipSecure"></td>
			...
			<tr>
				<td colspan="3"> Ship From :<b> <br>
						<?php echo $order_info['sender_name'] ?></b><br>
					<?php echo $order_info['pickup_email'] ?><b>
			...
			<tr>
				<td class="td" colspan="3" style="text-align:center;">
					<?php //if(!empty($oreder_info['uddan_barcode_text']) ) :
					?>
					<?php
