<div class="page">
	<div class="page-header">
		<h1 class="page-title">Generate Xpressbees AIR AWB</h1>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?= base_url('dashboard'); ?>">Home</a></li>
			<li class="breadcrumb-item active">Generate Xpressbees AIR AWB</li>
		</ol>
			...
			<div class="panel">
				<div class="panel-body container-fluid">
					<label class="text-primary" style="font-size: 18px;">
						<h3 class="text-primary" style="font-style:bold;">Total Airwaybill: <span id="totalAwbxpressbessair">00</span> </h3>
					</label>
					<div class="row row-lg">
						...
						<!-- <select name="logistic" id="logistic" class="form-control select2" required="">
									...
									?>
                                            <option value="<?php // $logisticVal['api_name']; 
															?>"><?php //$logisticVal['logistic_name']; 
																?></option>
                                    <?php // }
									//} 
									?>
						...
						<div class="col-md-3">
							<div class="form-group form-material">
								...
								<select name="order_type" id="order_type_xpressbessair" class="form-control select2" required="">
									<option value="">Select Order Type</option>
									<option value="COD">COD</option>
									<option value="PREPAID">Prepaid</option>
								</select>
								<input type="hidden" name="is_air" id="is_air" value="1">
