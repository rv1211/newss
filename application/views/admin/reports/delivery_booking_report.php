...
<div class="page">
    ...
    <div class="page-header">
        <h1 class="page-title">Delivery Booking</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('dashboard'); ?>">Home</a></li>
            <!-- <li class="breadcrumb-item"><a href="javascript:void(0)">Create Order</a></li> -->
            <li class="breadcrumb-item active">Delivery Booking</li>
        </ol>
    </div>
    <!-- end page header -->
    <!-- start page content -->
    <div class="page-content">
        <form action=<?php echo base_url('delivery-booking-report') ?> name="pincode_import_form12" method="POST" id="" autocomplete="off" enctype="multipart/form-data">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        Delivery Booking Report
                        <hr>
                    </h3>
                </div>
                <!-- end panel heading -->
                    ...
                    <div class="row row-lg">
                        <div class="col-md-1">
                            <div class="form-group form-material">
                                <button type="submit" id="intransit_booking_report" class="btn btn-primary waves-effect waves-classic waves-effect waves-classic excel">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
