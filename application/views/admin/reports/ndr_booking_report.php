...
<div class="page">
    ...
    <div class="page-header">
        <h1 class="page-title">NDR Booking</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('dashboard'); ?>">Home</a></li>
            <!-- <li class="breadcrumb-item"><a href="javascript:void(0)">Create Order</a></li> -->
            <li class="breadcrumb-item active">NDR Booking</li>
        </ol>
    </div>
    <!-- end page header -->
    <!-- start page content -->
    <div class="page-content">
        <form action=<?php echo base_url('ndr-booking-report') ?> name="pincode_import_form12" method="POST" id="" autocomplete="off" enctype="multipart/form-data">
            <div class="panel">
